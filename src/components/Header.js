    ...
    render() {
        ...
        return (
            ...
            !isForgotPasswordPage && (
                <div>
                    <nav
                        className={toggleLogo ? "navbar navbar-expand-md navbar-dark bg-dark collapse-logo" : "navbar navbar-expand-md navbar-dark bg-dark"}>
                        <div className="navbar-brand">
                            ...
                            <a href="javascript:void(0);" className="pull-right"
                               onClick={() => this.setState({navClass: !navClass, toggleLogo: !toggleLogo})}>
              ...
              />
                            ...
                            <ul style={{cursor: 'pointer'}} onClick={() => this.setState({open: !(this.state.open)})}
