            ...
            <div className="flex_section">
                <div className="card text-center dashboard">
                    ...
                    <div className="card-block">
                        ...
                        <p>
                            Record a session and bookmark important moments as they happen.
                            Remember to keep the call on speaker.
                        </p>
                ...
                <div className="card text-center dashboard">
                    ...
                    <div className="card-block">
                        ...
                        <p>
                            Connect your Google account to synthesize across docs. Make sure
                            your files are formatted correctly.
                        </p>
