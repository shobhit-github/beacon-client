...
class Docs extends Component {
    ...
    componentDidMount() {
        ...
        document.onkeyup = function (e) {
            ...
            if (e.ctrlKey && (e.which === 106 || e.which === 74)) {
                ...
                timeStamp = parseInt(timeStamp[1], 0);
                if (timeStamp > 0) {
    ...
    jQueryUses($this) {
        ...
        setTimeout(() => {
            ...
            $(".public-DraftStyleDefault-block").find(timeBlock).append('<span class="del-timeStamp">&times;</span>');
            ...
            $(document).on("click", ".del-timeStamp", function () {
                $(this).closest(draftBlock).remove()
            });
        }, 50);
