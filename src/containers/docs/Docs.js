      ...
      <div className="main-content">
        <div className="row">
          ...
          <div
            ...
            className="col-sm-12 col-md-12 col-lg-7 sidearea player-div p_left_50"
          >
        ...
        <div className="row">
          <div
            ...
            className="col-sm-12 col-md-12 col-lg-7 sidearea p_left_50"
          >
          ...
          <div
            ...
            className="col-sm-10 col-10 col-md-12 col-lg-3 p_rlt_zero toltip_section"
          >
            {showGreen ? (
            ...
            {showWhite ? (
              <div className="quicktip greenbg">
                ...
                <ul>
                  <li>
                    A copy of your work is automatically saved every X seconds.
                    Click the history button to the right to view and restore
                    previous versions.
                  </li>

                  <li>- Ctrl + S to save at any time.</li>
                </ul>
              </div>
            ) : null}
          </div>
