              ...
              {processing ? (
                [
                  <div className="card-block" key="first">
                    <p>
                      We are processing your file. You can access it using the
                      link below once it's ready.
                    </p>
                  </div>,
                  <div className="row justify-content-center" key="second">
                    <button className="btn drive-btn">
                      <CircularProgress size={15} color={"inherit"} /> Not
                      stored on drive yet
                    </button>
                  </div>
                ]
                ...
                <div className="card-block">
                  ...
                  <p>
                    We couldn't process your files because <br />
                    ...
                    and try again. If you have any feedback, questions, or
